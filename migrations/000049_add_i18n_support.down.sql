...
ALTER TABLE account_accounts ALTER COLUMN name TYPE VARCHAR(255) USING name->>'en_US';
...
ALTER TABLE stock_warehouses ALTER COLUMN name TYPE VARCHAR(255) USING name->>'en_US';
