...
| **3** | المحاسبة (account.move) | M0, M1, M2 | 5-7 أيام | 🔴 حرج | ✅ مكتملة |
| **4** | المبيعات (sale.order) | M1, M2, M3 | 3-4 أيام | 🟡 مهم | ✅ مكتملة |
| **5** | المشتريات (purchase.order) | M1, M2, M3 | 2-3 أيام | 🟡 مهم | ✅ مكتملة |
| **6** | المخزون (stock.picking) | M2, M4, M5 | 4-5 أيام | 🟡 مهم | ✅ مكتملة |
| **7** | CRM (crm.lead) | M1 | 2-3 أيام | 🟢 اختياري | ✅ مكتملة |
| **8** | المدفوعات (account.payment) | M3 | 3 أيام | 🟡 مهم | ✅ مكتملة |
| **9** | الموارد البشرية (hr.employee) | M1 | 3 أيام | 🟢 اختياري | ✅ مكتملة |
